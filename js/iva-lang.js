...
(function(){
  ...
  var EN = {
    ...
    '2. İç modül': '2. Inner module',
    'Gövdeye oturan iç taşıyıcı': 'Inner carrier that seats into the body',
    '3. Hoparlör': '3. Speaker',
    'Sesli yanıt ve bildirim sesleri': 'Spoken replies and notification sounds',
    '4. Elektronik kart': '4. Main board',
    'Ana işlemci, Wi-Fi ve ses işleme': 'Main processor, Wi-Fi and audio processing',
    '5. İç braket': '5. Inner bracket',
    'Kartı ve hoparlörü sabitler': 'Holds the board and the speaker in place',
    '6. Yan modül': '6. Side module',
    'Mikrofon ve bağlantı açıklıkları': 'Microphone and connector openings',
